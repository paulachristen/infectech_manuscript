...
ggsave(file.path(file_path_plots, "Received_Preferred_by_income.pdf"), width = 14, height = 10, dpi = 300)
...
# Save the plot
ggsave(file.path(file_path_plots, "Received_vs_Preferred_by_income_scatter.pdf"), width = 14, height = 10, dpi = 300)
```
...
ggsave(file.path(file_path_plots, "barplot_metrics_by_income_colored_overall.pdf"), width = 13.3, height = 13, dpi = 300)
...
# Save plot (optional)
ggsave(file.path(file_path_plots, "confidence_in_modelling_results.pdf"), width = 16, height = 8, dpi = 300)
```
...
# Step 7: Export
ggsave(file.path(file_path_plots, "barriers_by_income.pdf"), width = 15, height = 10, dpi = 300)
```
